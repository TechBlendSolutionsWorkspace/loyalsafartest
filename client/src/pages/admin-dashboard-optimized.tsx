...
export default function AdminDashboard() {
  ...
  // Product Management State - CRITICAL: Only manual updates
  ...
  // NO AUTO-REFRESH - Manual only to prevent form conflicts
  ...
  // FIXED: Product Mutations - Only manual refresh after success
  const createProductMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      resetProductForm();
      // Manual refresh only after successful save
      setTimeout(() => {
        refetchProducts();
        refetchStats();
      }, 200);
  ...
  // CRITICAL: Proper form reset to prevent conflicts
  ...
  // FIXED: Proper product dialog opening with complete data population
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="products" className="space-y-6">
            ...
            {/* OPTIMIZED Product Dialog - No auto-updates */}
          ...
          <TabsContent value="users" className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <h2 className="text-xl sm:text-2xl font-bold">User Management & Rights</h2>
            ...
            <Dialog open={showUserDialog} onOpenChange={(open) => {
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {selectedUser ? 'Update user information and permissions' : 'Create a new user account with specific rights'}
                  </DialogDescription>
                </DialogHeader>
                <form onSubmit={handleUserSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label>User Permissions & Rights</Label>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 p-4 border rounded-lg bg-slate-50/50">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Select specific permissions for granular access control. Admin role grants all permissions.
                    </p>
                  </div>
