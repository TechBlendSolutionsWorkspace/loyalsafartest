          ...
          <div className="text-white text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6 mt-8 sm:mt-12 justify-center md:justify-start">
              <div className="flex items-center text-blue-100 text-sm sm:text-base">
                <Shield className="h-6 w-6 sm:h-8 sm:w-8 text-green-400 mr-2" />
                <span>Safe Payment</span>
              </div>
              <div className="flex items-center text-blue-100 text-sm sm:text-base">
                <Award className="h-6 w-6 sm:h-8 sm:w-8 text-blue-400 mr-2" />
                <span>Genuine Access</span>
              </div>
              <div className="flex items-center text-blue-100 text-sm sm:text-base">
                <Rocket className="h-6 w-6 sm:h-8 sm:w-8 text-purple-400 mr-2" />
