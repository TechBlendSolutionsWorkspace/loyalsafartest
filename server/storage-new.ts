    ...
    this.testimonials = [
      {
        ...
        rating: 5,
        review: "Excellent service! Got my Netflix subscription instantly at an incredible price. Highly recommended! I'm from Mumbai and have been getting all OTT platforms from here for 2 years.",
        featured: true,
      },
      {
        id: nanoid(),
        ...
        rating: 5,
        review: "Best prices in the market! Been using their services for months without any issues. I'm from Delhi and got the Hotstar + Netflix combo for my family.",
        featured: true,
      },
      {
        id: nanoid(),
        ...
        rating: 5,
        review: "Excellent customer service and quick delivery. The Amazon Prime + Spotify combo was fantastic. Recommending from Bangalore.",
        featured: true,
      },
      {
        id: nanoid(),
        ...
        rating: 5,
        review: "Got Hotstar subscription for IPL season. Quality was excellent and price was very reasonable. I'm from Pune.",
        featured: true,
      },
    ];
